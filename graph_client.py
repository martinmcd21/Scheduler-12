...
class GraphClient:
    ...
    def create_event(self, event_payload: Dict[str, Any], send_updates: str = "all") -> Dict[str, Any]:
        """Create a calendar event and (optionally) send updates to attendees.

        NOTE:
        Microsoft Graph will not reliably send meeting requests to attendees unless
        the 'sendUpdates' query parameter is provided. Defaulting to 'all' ensures
        invitations/updates are emailed to all attendees when an event is created.
